...
CREATE TABLE PRODUCTOS_SERVICIOS (
    ...
    CodProd INT NOT NULL,
    PRIMARY KEY (RIFSuc, CodProd),
    FOREIGN KEY (RIFSuc, CodProd) REFERENCES PRODUCTOS(RIFSuc, CodProd) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE REQUISICIONES_COMPRA (
    ...
    RIFSuc VARCHAR(12) NOT NULL,
    CodProd INT NOT NULL,
    FOREIGN KEY (RIFSuc, CodProd) REFERENCES PRODUCTOS(RIFSuc, CodProd) ON UPDATE CASCADE ON DELETE NO ACTION
);
...
CREATE TABLE REGISTRAN_FACT_PROD (
    ...
    PRIMARY KEY (NumFactTienda, RIFSuc, CodProdTienda),
    FOREIGN KEY (NumFactTienda) REFERENCES FACTURAS_TIENDAS(CodF) ON UPDATE CASCADE ON DELETE NO ACTION,
    FOREIGN KEY (RIFSuc, CodProdTienda) REFERENCES PRODUCTOS_TIENDA(RIFSuc, CodProd) ON UPDATE CASCADE ON DELETE NO ACTION
);
...
CREATE TABLE CONTRATAN_ACT_ORDENS_PROD_SERV (
    ...
    PRIMARY KEY (CodServicio, NroActividad, NroOrenServ, RIFSuc, CodProductoServ),
    ...
    FOREIGN KEY (RIFSuc, CodProductoServ) REFERENCES PRODUCTOS_SERVICIOS(RIFSuc, CodProd) ON UPDATE NO ACTION ON DELETE NO ACTION
);
